...
namespace Hotel_Management.Controllers
{
        ...
        public ActionResult Index()
        {
            ...
            var bookings = db.Bookings.Where(b => b.CustomerID == customerId) // Lọc theo CustomerID
                .ToList()
                .Select(booking => new BookingDetailViewModel
                {
                    ...
                    FloorNumber = booking.Room.Floor.FloorNumber,
                    BuildingName = booking.Room.Floor.Building.BuildingName,
                    BuildingAddress = booking.Room.Floor.Building.Address,
